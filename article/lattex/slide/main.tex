...
\logo{\includegraphics[height=0.9cm]{logo.png}\vspace*{-.055\paperheight}\hspace*{.85\paperwidth}}
...
\begin{frame}{Sumário}
    \begin{block}{}
        \begin{enumerate}
            ...
            \item O Problema
            \item Proposta (Métodos Exatos, Aproximados e Híbrida)
...
Selecionar os atributos corretos para a construção de metamodelos é fundamental para otimizar recomendações de algoritmos \cite{vanschoren2018meta, he2021automl, wang2023onestep}.
\end{block}
...
\begin{itemize}
    \item \textbf{Características do meta-dataset:} Utilizar o meta-dataset com meta-features de 94 datasets do \textit{OpenML} (Exemplo 4), totalizando 1153 meta-features extraídas.
    \item \textbf{Maximizar a acurácia:} Encontrar um subconjunto que maximize a acurácia preditiva do meta-modelo.
    \item \textbf{Impacto do pré-processamento:} O método exato não o utiliza; no entanto, os métodos aproximados e a abordagem híbrida aplicam o pré-processamento para aprimorar o desempenho.
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item \textbf{Filtro:} Utilização do filtro de \textit{Mutual Information} culminando num grupo refinado das 150 características mais relevantes.
\end{itemize}
\end{block}
...
\begin{itemize}
    \item A Abordagem Híbrida (AG Esparso) atingiu a expressiva acurácia de \textbf{71,05\%} necessitando de apenas \textbf{18 atributos}.
\end{itemize}
...
\vspace{0.3cm}
\begin{itemize}
    \item \textbf{Particularidade das meta-features:} Por possuírem natureza descritiva, estatística, entre outras, os modelos baseados em árvores desempenharam melhor que os demais.
\end{itemize}
\begin{itemize}
    \item \textbf{Trade-off:} Modelos híbridos obtiveram o melhor desempenho avaliativo em troca do alto fardo e custo computacional sequencial. Alternativamente ao gargalo, estudos propõem abstrações transformando o espaço em contínuo \cite{metafs2023}.
\end{itemize}
\end{frame}
